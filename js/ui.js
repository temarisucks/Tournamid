...
function goToCharSelect(mode) {
    ...
    else offlineInitCharSelect(); // pick → confirm for every offline mode + training
...
function selectNeedCount() {
    ...
    return 2; // PVP / CPU / CPU_WATCH need P1 + P2
}
